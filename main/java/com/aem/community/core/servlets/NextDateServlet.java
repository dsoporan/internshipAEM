...
@SlingServlet(
        methods = {"GET"},
        paths = {"/bin/nextDateServlet"},
        metatype = true)
public class NextDateServlet extends SlingAllMethodsServlet {
    ...
    protected void doGet(SlingHttpServletRequest request, SlingHttpServletResponse response) throws ServerException, IOException {
        ...
        response.sendRedirect("http://localhost:4502/content/AEM62App/en/ping-pong-page.html?date=" + nextDate);
    }
}